...
import io.cordova.zhihuiyingyuan.activity.InfoDetailsActivity;
import io.cordova.zhihuiyingyuan.activity.SplashActivity;
import io.cordova.zhihuiyingyuan.bean.CountBean;
import io.cordova.zhihuiyingyuan.bean.OAMsgListBean;
import io.cordova.zhihuiyingyuan.bean.SysMsgBean;
import io.cordova.zhihuiyingyuan.service.UpdateServiceSys1;
import io.cordova.zhihuiyingyuan.service.UpdateServiceSys2;
import io.cordova.zhihuiyingyuan.service.UpdateServiceSys3;
...
public class NewAppTwoWidget extends AppWidgetProvider {
    ...
    private final String action1 = "io.cordova.zhihuiyingyuan.appwidgetprovider.ll01";
    private final String action2 = "io.cordova.zhihuiyingyuan.appwidgetprovider.ll02";
    private final String action3 = "io.cordova.zhihuiyingyuan.appwidgetprovider.ll03";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if(action.equals(action1)){
            remoteViews.setTextColor(R.id.tv_01, Color.parseColor("#116562"));
            remoteViews.setTextColor(R.id.tv1, Color.parseColor("#116562"));
            remoteViews.setTextColor(R.id.tv_02, Color.parseColor("#ffffff"));
            remoteViews.setTextColor(R.id.tv2, Color.parseColor("#ffffff"));
            remoteViews.setTextColor(R.id.tv_03, Color.parseColor("#ffffff"));
            remoteViews.setTextColor(R.id.tv3, Color.parseColor("#ffffff"));
            ...
            remoteViews.setTextColor(R.id.tv_01, Color.parseColor("#ffffff"));
            remoteViews.setTextColor(R.id.tv1, Color.parseColor("#ffffff"));
            remoteViews.setTextColor(R.id.tv_02, Color.parseColor("#116562"));
            remoteViews.setTextColor(R.id.tv2, Color.parseColor("#116562"));
            remoteViews.setTextColor(R.id.tv_03, Color.parseColor("#ffffff"));
            remoteViews.setTextColor(R.id.tv3, Color.parseColor("#ffffff"));
           ...
           /* Intent intent2 = new Intent(context,BaseWebCloseActivity.class);
            ...
            remoteViews.setTextColor(R.id.tv_02, Color.parseColor("#ffffff"));
            remoteViews.setTextColor(R.id.tv2, Color.parseColor("#ffffff"));
            remoteViews.setTextColor(R.id.tv_03, Color.parseColor("#116562"));
            remoteViews.setTextColor(R.id.tv3, Color.parseColor("#116562"));
    ...
    public void onEnabled(Context context) {
       ...
       /* PackageManager pm = context.getPackageManager();
        pm.setComponentEnabledSetting(
                new ComponentName("io.cordova.jhschool","io.cordova.jhschool.NewAppWidget.class"),
