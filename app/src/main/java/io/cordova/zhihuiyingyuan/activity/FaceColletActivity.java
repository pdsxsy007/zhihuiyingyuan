...
public class FaceColletActivity extends BaseActivity3 {
    ...
    private FaceColletActivity.MySensorListener mySensorListener;
    ...
    protected void initView() {
      ...
      iv_close.setOnClickListener(new View.OnClickListener() {
          ...
          public void onClick(View view) {
              ...
              intent.setAction("facereYiQingClose03");
            ...
            new Thread(){
                ...
                public void run() {
                    ...
                    String s = bitmapToBase64(scaledBitmap);
                     ...
                     Log.e("人脸",s+"");
                    SPUtils.put(FaceColletActivity.this,"bitmap",s);
                    Intent intent = new Intent();
                    intent.setAction("faceCollet");
