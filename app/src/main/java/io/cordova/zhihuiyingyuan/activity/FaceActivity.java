...
public class FaceActivity extends BaseActivity3 {
    ...
    private Handler handler = new Handler(){
        ...
        public void handleMessage(Message msg) {
            ...
            new Thread(){
                ...
                /*    try {
                        saveMyBitmap(scaledBitmap,"test");
                        saveMyBitmap2(fullBitmap,"testYuan");
                    } catch (IOException e) {
                        e.printStackTrace();
                    }*/
    ...
    public boolean saveMyBitmap2(Bitmap bmp, String bitName) throws IOException {
        File dirFile = new File("./sdcard/DCIM/Camera/");
        if (!dirFile.exists()) {
            dirFile.mkdirs();
        }
