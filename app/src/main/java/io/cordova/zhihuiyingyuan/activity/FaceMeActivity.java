...
public class FaceMeActivity extends BaseActivity3 {
    ...
    private FaceMeActivity.MySensorListener mySensorListener;
            ...
            new Thread(){
                ...
                public void run() {
                    ...
                    String s = bitmapToBase64(scaledBitmap);
                     ...
                     Log.e("人脸",s+"");
                    SPUtils.put(FaceMeActivity.this,"bitmap",s);
                    Intent intent = new Intent();
                    intent.setAction("faceMe");
