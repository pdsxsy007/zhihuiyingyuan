...
import io.cordova.zhihuiyingyuan.web.WebLayout2;
...
import io.cordova.zhihuiyingyuan.web.FileUtil;
...
//        locationBean.setLatitude("112332132423424324");
//        locationBean.setLongitude("112332132423424324");
//        Gson gson = new Gson();
//        String s = gson.toJson(locationBean);
//        String jsonParams = s;
//        //Log.e("得到的结果是",jsonParams);
    }
...
//        initPullRefresh();
    ...
    private void setWeb() {
        ...
        String tgc = (String) SPUtils.get(getActivity(), "TGC", "");
        CookieUtils.syncCookie("http://platform.gilight.cn", "CASTGC=" + tgc, getContext());
