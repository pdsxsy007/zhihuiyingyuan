...
import io.cordova.zhihuiyingyuan.adapter.MyAdapter2;
import io.cordova.zhihuiyingyuan.bean.OAMsgListBean2;
...
public class NewFinishMsgActivity extends BaseActivity2  {
                ...
                .execute(new StringCallback() {
                    ...
                    public void onSuccess(Response<String> response) {
                        ...
                        if(oaMsgListBean.getObj().size() > 0){
                            ...
                            adapter = new MyAdapter2(NewFinishMsgActivity.this,R.layout.item_to_do_my_msg,oaMsgListBean2.getObj());
