...
import io.cordova.zhihuiyingyuan.activity.FaceServiceActivity;
...
public class DargeFaceUtils {
     ...
     * @param context
     */
    public static void jargeFace(ServiceAppListBean.ObjBean.AppsBean appsBean, Context context){
    ...
    private static void showFaceActivity(Context context) {
        Intent intent = new Intent(context,FaceServiceActivity.class);
        context.startActivity(intent);
        imageid = 0;
    }
    ...
    public static void cameraTask(ServiceAppListBean.ObjBean.AppsBean appsBean,Context context) {
