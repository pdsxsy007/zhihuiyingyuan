...
import io.cordova.zhihuiyingyuan.MyTestActivity;
...
//                }
    ...
    private void setGoPushMsg(String msgType) {
        ...
        if (!StringUtils.isEmpty(msgType)){
            ...
            intent = new Intent(MyApp.getInstance(), MyTestActivity.class);
            intent.putExtra("type","测试");
            intent.putExtra("msgType","测试");
            intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            startActivity(intent);
        }
    }
