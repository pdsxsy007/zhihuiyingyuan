...
public class BaseWebActivity4 extends AppCompatActivity implements GestureDetector.OnGestureListener,PermissionsUtil.IPermissionsCallback {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        downLoadType = (String) SPUtils.get(BaseWebActivity4.this, "downLoadType", "");
...
/*
    ...
    private void initListener() {
        ...
        rbSc.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                m_Dialog_browser = new MyDialog(BaseWebActivity4.this, R.style.DialogTheme);

                View view1 = LayoutInflater.from(BaseWebActivity4.this).inflate(R.layout.dialog_browser, null);
                ...
                mLinearLayoutManager = new LinearLayoutManager(BaseWebActivity4.this, LinearLayout.HORIZONTAL,false);
                ...
                BrowserAdapter browserAdapter = new BrowserAdapter(BaseWebActivity4.this,R.layout.item_browser,list);
    ...
    private void copyString(String appServiceUrl) {
        ...
        ToastUtils.showToast(BaseWebActivity4.this,"复制成功!");
    }
        ...
        rl_sure.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mAgentWeb = AgentWeb.with(BaseWebActivity4.this)
                        ...
                        //.setMainFrameErrorView(R.layout.agentweb_error_page, -1)
                        .setSecurityType(AgentWeb.SecurityType.STRICT_CHECK)
                        .setWebLayout(new WebLayout4(BaseWebActivity4.this))
                        .setOpenOtherPageWays(DefaultWebClient.OpenOtherPageWays.ASK)//打开其他应用时，弹窗咨询用户是否前往其他应用
                        .interceptUnkownUrl() //拦截找不到相关页面的Scheme
...
//            AgentWebConfig.clearDiskCache(this.getContext());
    ...
    public class AndroidInterface {
        ...
        public void nativeGetEquipmentId(final String invocationLogAppId,final String invocationLogFunction) {
            if (EasyPermissions.hasPermissions(BaseWebActivity4.this, Manifest.permission.READ_PHONE_STATE)) {
    ...
    private void testTakePhoto() {
        ...
        if(Build.VERSION.SDK_INT>=24){
            fileUri1= FileProvider.getUriForFile(BaseWebActivity4.this,"io.cordova.zhihuiyingyuan.provider",mPhotoFile);
                                ...
                                if(typeName.equals(invocationLogFunction)){
                                    if(invocationLogFunction.equals("nativeVerifyUserAndFace")){
                                        deliver.post(new Runnable() {
                                            @Override
                                            public void run() {
                                                SPUtils.put(BaseWebActivity4.this,"bitmap","");
                                                Intent intent = new Intent(BaseWebActivity4.this,FaceYiQingActivity.class);
            ...
            if(action.equals("facereYiQing")){
                ...
                if(imageid == 0){
                    if(FaceActivity != null){
                        ...
                        String s = (String)SPUtils.get(BaseWebActivity4.this, "bitmap", "");
                        String imei = (String) SPUtils.get(BaseWebActivity4.this, "imei", "");
                        String username = (String) SPUtils.get(BaseWebActivity4.this, "phone", "");
...
//                            BaseWebActivity.this.finish();
    ...
    public void onLoctionCoordinate(){
        ...
        locationBean.setSignRecordEquipmentId(MobileInfoUtils.getIMEI(BaseWebActivity4.this));
    ...
    protected void onResume() {
        ...
        if(!isLoading2 .equals("")){
            ViewUtils.createLoadingDialog2(BaseWebActivity4.this,true,"人脸识别中");
            SPUtils.put(getApplicationContext(),"isloading2","");
