...
import io.cordova.zhihuiyingyuan.face.view.RefreshProgress;
import io.cordova.zhihuiyingyuan.face2.FaceView;
...
public class FaceServiceActivity extends BaseActivity3 {

    io.cordova.zhihuiyingyuan.face2.CameraView cameraView;
    FaceView faceView;
    Bitmap fullBitmap;

    private SensorManager sensorManager;
    private Sensor sensor;
    private FaceServiceActivity.MySensorListener mySensorListener;
    ...
    protected void initView() {
        ...
        cameraView = (io.cordova.zhihuiyingyuan.face2.CameraView) findViewById(R.id.camera_view);
        faceView = (FaceView) findViewById(R.id.face_view);
        iv = (ImageView) findViewById(R.id.iv);
        //cameraView.setFaceView(faceView);
        cameraView.setOnFaceDetectedListener(new io.cordova.zhihuiyingyuan.face2.CameraView.OnFaceDetectedListener() {
            @Override
      ...
      iv_close.setOnClickListener(new View.OnClickListener() {
          ...
          public void onClick(View view) {
              ...
              intent.setAction("facereYiQingClose01");
                ...
                public void run() {
                   ...
                   /* ByteArrayOutputStream baos=new ByteArrayOutputStream();
                    ...
                    String s = bitmapToBase64(scaledBitmap);
                     ...
                     Log.e("人脸",s+"");
                    SPUtils.put(FaceServiceActivity.this,"bitmap",s);
                    Intent intent = new Intent();
                    intent.setAction("faceService");
