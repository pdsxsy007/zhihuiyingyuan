...
public class UpdateServiceSys1 extends RemoteViewsService {
    ...
    class ListRemoteViewsFactory implements RemoteViewsFactory{
        ...
        public RemoteViews getViewAt(int position) {
            ...
            long messageSendTime = objBean.getMessageSendTime();
            SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd :HH:mm:ss");
            String sd = sdf.format(new Date(Long.parseLong(String.valueOf(messageSendTime))));//时间戳转换成时间
            rv.setTextViewText(R.id.tv_time, sd.substring(11,sd.length()-3));
