...
public class UpdateService4 extends RemoteViewsService {
    ...
    class ListRemoteViewsFactory implements RemoteViewsFactory{
        ...
        private List<AppWidgetBean.ThursdayList> thursdayLists;
        ...
        public ListRemoteViewsFactory(Context context, Intent intent){
            ...
            thursdayLists = appWidgetBean.getAttributes().getThursdayList();
        ...
        public RemoteViews getViewAt(int position) {
            ...
            AppWidgetBean appWidgetBean = JsonUtil.parseJson(content,AppWidgetBean.class);
            thursdayLists = appWidgetBean.getAttributes().getThursdayList();
            if(position<0 || position>=thursdayLists.size())
                return null;
            AppWidgetBean.ThursdayList fridayList = thursdayLists.get(position);
