...
public class UpdateService1 extends RemoteViewsService {
    ...
    class ListRemoteViewsFactory implements RemoteViewsFactory{
        ...
        private List<AppWidgetBean.MondayList> wednesdayLists;
        ...
        public ListRemoteViewsFactory(Context context, Intent intent){
            ...
            wednesdayLists = appWidgetBean.getAttributes().getMondayList();
        ...
        public RemoteViews getViewAt(int position) {
            ...
            if(position<0 || position>=wednesdayLists.size())
                return null;
            AppWidgetBean.MondayList fridayList = wednesdayLists.get(position);
