...
public class UpdateService6 extends RemoteViewsService {
    ...
    class ListRemoteViewsFactory implements RemoteViewsFactory{
        ...
        private List<AppWidgetBean.SaturdayList> fridayLists;
        ...
        public ListRemoteViewsFactory(Context context, Intent intent){
            ...
            fridayLists = appWidgetBean.getAttributes().getSaturdayList();
        ...
        public RemoteViews getViewAt(int position) {
            ...
            if(position<0 || position>=fridayLists.size())
                return null;
            AppWidgetBean.SaturdayList fridayList = fridayLists.get(position);
