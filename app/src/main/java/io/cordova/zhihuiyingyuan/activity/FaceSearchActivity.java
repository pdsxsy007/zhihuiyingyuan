...
public class FaceSearchActivity extends BaseActivity3 {
    ...
    private FaceSearchActivity.MySensorListener mySensorListener;
    ...
    protected void initView() {
      ...
      iv_close.setOnClickListener(new View.OnClickListener() {
          ...
          public void onClick(View view) {
              ...
              intent.setAction("facereYiQingClose04");
            ...
            new Thread(){
                ...
                public void run() {
                    ...
                    String s = bitmapToBase64(scaledBitmap);
                     ...
                     Log.e("人脸",s+"");
                    SPUtils.put(FaceSearchActivity.this,"bitmap",s);
                    Intent intent = new Intent();
                    intent.setAction("faceSearch");
